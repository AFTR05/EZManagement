      ...
      body: SafeArea(
        child: CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(
              child: Padding(
                padding: EdgeInsets.fromLTRB(16 * scale, 20 * scale, 16 * scale, 8 * scale),
                child: Row(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            LocaleKeys.reportHeaderSubtitle.tr(),          // <- usando tr()
            ...
            // Lista
            SliverPadding(
              padding: EdgeInsets.fromLTRB(16 * scale, 8 * scale, 16 * scale, 24 * scale),
              sliver: SliverList.separated(
                ...
                itemBuilder: (context, i) => _reportCard(
                  ...
                  subtitle: (items[i]['subtitleKey'] as String).tr(),     // <- tr() aquí
          ...
          child: ListTile(
            leading: DecoratedBox(
              ...
              child: Padding(
                ...
                child: Icon(icon, color: EZColorsApp.ezAppColor, size: 22 * scale),
              ),
            ),
            title: Text(
